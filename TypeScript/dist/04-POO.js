...
// Molde
class Gato {
    nombre; // Puclic deja llamar a la propiedad fuera de la clase
    raza; // Private deja llamar a la propiedad solo dentro de la clase
    color; // Protected deja llamar a la propiedad dentro y en las clases que hereden la padre
