...
class Gato {
    ...
    public nombre:string // Puclic deja llamar a la propiedad fuera de la clase
    private raza:string // Private deja llamar a la propiedad solo dentro de la clase
    protected color:string // Protected deja llamar a la propiedad dentro y en las clases que hereden la padre
